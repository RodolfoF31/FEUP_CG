...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.objects = [this.plane, this.pyramid, this.cone, this.MyUnitCube, this.tangram, this.MyPrism, this.MyCylinder];
    ...
    initMaterials() {
        ...
        var color = this.hexToRgbA("#A96232");
        this.material4.setAmbient(0, 0, 0, 1);
        this.material4.setDiffuse(color[0], color[1], color[2], 1);
        this.material4.setSpecular(0.2, 0.2, 0.2, 1);
