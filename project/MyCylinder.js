...
export class MyCylinder extends CGFobject {
    ...
    addVertices(currentX, currentY, currentZ, nextX, nextY, nextZ, s, t) {
        ...
        this.texCoords.push(s + 1/this.slices, t);
        this.texCoords.push(s, t + 1/this.stacks);
        this.texCoords.push(s + 1/this.slices, t + 1/this.stacks);
    }
